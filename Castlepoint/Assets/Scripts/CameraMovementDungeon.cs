...
public class CameraMovementDungeon : MonoBehaviour, IDataPersistence
{
    public void LoadData(GameData data)
	{
		maxPosition = data.maxPosDung;
        minPosition = data.minPosDung;
	}
	public void SaveData(GameData data)
	{
		data.maxPosDung = maxPosition;
        data.minPosDung = minPosition;
	}
